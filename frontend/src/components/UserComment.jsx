    ...
    <div className="relative font-sans text-right w-full  p-0 bg-white  border-b border-gray-400 pb-1">
      ...
      <div className='relative flex items-center justify-start my-2' >
        ...
        <div className="flex justify-between ml-1 mr-2">
          <img src={user.avatar_url} className="rounded-full w-11 aspect-square border-2 border-gray-200"/>
        </div>
        ...
        {/* Date */}
        <span className="absolute left-0 text-sm text-gray-500 mx-2 my-2">{created_at}</span>
      </div>
      ...
      {/* Comment text */}
      <div className={`text-right whitespace-pre-line mx-2 leading-6 mb-1 transition-all duration-300`}>
      ...
      {fullText.length>40 && (
        <div className="text-left items-center justify-center w-full p-0">
          <button className="text-purple-400 rounded-none bg-white text-sm mt-1 hover:text-purple-600 border-none
                              focus:outline-none transition-colors w-full" onClick={toggleExpand}>
      ...
      <div className='flex items-center justify-end'>
        ...
        <div className='flex items-center mx-2'>
        {likes!==0 && (<span className='text-xl text-gray-900 mt-1'>{likes}</span>)}
          <button className='flex bg-white border-none focus:outline-none w-full p-0 items-center justify-center'
                  >
        ...
        <div className='flex items-center mx-2'>
          {dislikes!==0 && (<span className='text-xl text-gray-900 mt-1'>{dislikes}</span>)}
          <button className='flex bg-white border-none focus:outline-none w-full p-0 items-center justify-center'>
